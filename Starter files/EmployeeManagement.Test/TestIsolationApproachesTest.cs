...
{
    public class TestIsolationApproachesTest
    {
        [Fact]
        public async Task AttendCourseAsync_CourseAttended_SuggestedBonusMustCorrectlyBeCalculated()
        {
            // Arrange
        ...
        public async Task PromoteInternalEmployeeAsync_IsEligible_JobLevelMustBeIncremented()
        {
            // Arrange
